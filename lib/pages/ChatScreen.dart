...
import 'package:eattlystefan/utils/loading.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "$peerName",
          style: textStyle(greenColor, 17.0, FontWeight.w500),
        ),
        centerTitle: true,
      ),
      body: ChatScreen(
...
class ChatScreen extends StatefulWidget {
  ...
  State createState() => ChatScreenState(
      peerId: peerId, peerAvatar: peerAvatar, currentUserId: currentUserId);
}
...
class ChatScreenState extends State<ChatScreen> {
  ...
  getUsersWhomCurrentUserIsFollowing() {
  ...
  bool isLastMessageLeft(int index) {
    if ((index > 0 &&
            listMessage != null &&
            listMessage[index - 1].data()['idFrom'] == currentUserId) ||
        index == 0) {
      return true;
    } else {
      return false;
  ...
  Widget buildSticker() {
    return Container(
      ...
      decoration: BoxDecoration(
          border: Border(top: BorderSide(color: greenColor, width: 0.5)),
          color: Colors.white),
